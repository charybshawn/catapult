            ...
            ->schema([
                Forms\Components\Section::make('Basic Information')
                    ->schema([
                        ...
                        // Hidden field for consumable unit (always grams for seeds)
                        Forms\Components\Hidden::make('consumable_unit_id')
                            ->default(fn () => \App\Models\ConsumableUnit::where('symbol', 'g')->first()?->id)
                            ->dehydrated(),
        ...
        return static::configureTableDefaults($table)
            ...
            ->columns([
                ...
                Tables\Columns\TextColumn::make('remaining_seed')
                    ...
                    ->numeric()
                    ->sortable(query: fn (Builder $query, string $direction): Builder => $query->orderByRaw("(total_quantity - consumed_quantity) {$direction}")
                    )
                    ->size('sm'),
                ...
                Tables\Columns\TextColumn::make('percentage_remaining')
                    ...
                    ->sortable(query: fn (Builder $query, string $direction): Builder => $query->whereNotNull('total_quantity')
