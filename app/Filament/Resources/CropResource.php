        ...
        return static::configureTableDefaults($table)
            ...
            ->modifyQueryUsing(function (Builder $query): Builder {
                ...
                return $query->select([
                        ...
                        DB::raw('MIN(crops.time_to_next_stage_status) as time_to_next_stage_display'),
                        DB::raw('MIN(crops.stage_age_minutes) as stage_age_minutes'),
                        DB::raw('MIN(crops.stage_age_status) as stage_age_display'),
                        DB::raw('MIN(crops.total_age_minutes) as total_age_minutes'),
                        DB::raw('MIN(crops.total_age_status) as total_age_display'),
                        DB::raw('NULL as expected_harvest_at'),
