...
use App\Filament\Resources\ItemPhotoResource\Pages;
use App\Filament\Resources\ItemPhotoResource\RelationManagers;
...
class ItemPhotoResource extends Resource
{
    ...
    {
        return [
            'index' => Pages\ListItemPhotos::route('/'),
            'create' => Pages\CreateItemPhoto::route('/create'),
            'edit' => Pages\EditItemPhoto::route('/{record}/edit'),
        ];
    }
}
