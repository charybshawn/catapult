...
class ScheduledTask extends Model
{
    ...
    public static function getScheduledTasks(): Collection
    {
        ...
        return collect([
            ...
            static::createTask(4, 'orders:process-recurring', '0 6 * * *', 'Process recurring orders daily at 6 AM', 'Scheduled Task', true),
            static::createTask(5, 'invoices:generate-consolidated', '0 7 * * *', 'Generate consolidated invoices daily at 7 AM (after order processing)', 'Scheduled Task', true),
