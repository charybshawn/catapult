...
{
    /**
     * Add crop_batch_id column to crops table for grouping soaking batches.
     * 
     * This migration adds support for batch processing of crops during the soaking stage.
     * Multiple crops can share the same crop_batch_id when they are soaked together,
     * allowing for coordinated stage transitions and better resource management.
     */
    public function up(): void
    {
        Schema::table('crops', function (Blueprint $table) {
            // Add crop_batch_id column after the id column
    ...
    /**
     * Reverse the migration by removing the crop_batch_id column and its index.
     */
