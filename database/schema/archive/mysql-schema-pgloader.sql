...
CREATE TABLE activity_log (
  ...
  severity_level enum('debug','info','notice','warning','error','critical','alert','emergency') NOT NULL DEFAULT 'info',
...
CREATE TABLE activity_log_background_jobs (
  ...
  status enum('pending','processing','completed','failed','retrying','cancelled') NOT NULL DEFAULT 'pending',
...
CREATE TABLE order_statuses (
  ...
  stage enum('pre_production','production','fulfillment','final') NOT NULL,
...
CREATE TABLE orders (
  ...
  delivery_date date DEFAULT NULL,
  harvest_day enum('sunday','monday','tuesday','wednesday','thursday','friday','saturday') DEFAULT NULL,
  delivery_day enum('sunday','monday','tuesday','wednesday','thursday','friday','saturday') DEFAULT NULL,
  ...
  customer_type enum('b2b','website order','farmers market') NOT NULL DEFAULT 'b2b',
...
CREATE TABLE tasks (
  ...
  description text,
  task_type enum('watering','harvesting','seeding','general') NOT NULL,
  due_date date DEFAULT NULL,
  completed_at timestamp NULL DEFAULT NULL,
