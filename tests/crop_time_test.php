...
foreach ($crops as $crop) {
    ...
    echo "Planted at: {$crop->planted_at->format('Y-m-d H:i:s')}\n";
    echo "Time since planting: " . formatTimeDiff($crop->planted_at, now()) . "\n";
    ...
    if ($expectedHarvestDate) {
        $plantToHarvest = $crop->planted_at->diffInDays($expectedHarvestDate);
